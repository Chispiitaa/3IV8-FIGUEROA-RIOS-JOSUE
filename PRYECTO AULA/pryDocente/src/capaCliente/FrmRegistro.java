...
public class FrmRegistro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 420, 550));
    ...
    private void btnRegistrarseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarseActionPerformed
        ...
        if(password.equals("") || nombre.equals("") || contra.equals("")){
            ...
            ArrayList<Usuario> lista = obj.mostrar();
            for(Usuario nose: lista){
                JOptionPane.showMessageDialog(this, nose.getNombre());
            }
